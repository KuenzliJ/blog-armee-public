...
const FotoWiederholungskurse = async ({ searchParams }: { searchParams: any }) => {
  const query = searchParams?.query;

  // Abfragen nur für 'Wiederholungskurs' Kategorie, inklusive Suchfunktionalität
  const blogs = await prisma.foto.findMany({
    where: {
...
export default FotoWiederholungskurse;
